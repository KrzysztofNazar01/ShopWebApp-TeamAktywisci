...
class appAppKernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('F3Nr8rcRnL', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => 'prestadb', 'port' => '', 'dbname' => 'prestadb', 'user' => 'root', 'password' => 'admin', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d->addInstance('memcached', ($this->privates['memcached'] ?? $this->getMemcachedService()));
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('FgFoaKWkQ6Mvf3ujLFOF9XxMFC2Oy34rzZz3ThFmpDgTRc0W8fcnCc1Phm10rO1k'))), '/_fragment');
    }
    ...
    /**
     * Gets the private 'memcached' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected function getMemcachedService()
    {
        $a = new \Symfony\Component\Cache\Adapter\MemcachedAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection('memcached://localhost', ['lazy' => true]), 'lIkTICH7Ti', 0, ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));

        return $this->privates['memcached'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'modules_translation_paths' => [
                ...
                27 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                ...
                53 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
            ...
            'kernel.secret' => 'FgFoaKWkQ6Mvf3ujLFOF9XxMFC2Oy34rzZz3ThFmpDgTRc0W8fcnCc1Phm10rO1k',
